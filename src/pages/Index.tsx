    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <TabsTrigger 
            value="grid" 
            className="flex items-center gap-2 aria-selected:bg-primary aria-selected:text-primary-foreground aria-selected:font-medium aria-[selected=false]:text-muted-foreground aria-[selected=false]:hover:text-foreground transition-colors"
          >
